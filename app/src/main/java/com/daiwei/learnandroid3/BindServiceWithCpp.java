...
public class BindServiceWithCpp extends Service {

  private static final String TAG = BindServiceWithCpp.class.getSimpleName();
  ...
  private final class ServiceHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      ...
      Log.d(TAG, "done handleMessage " + msg.arg1);
    }
  }
